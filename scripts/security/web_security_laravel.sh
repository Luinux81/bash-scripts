...
echo ""
echo "Para completar el endurecimiento de seguridad, añade estas reglas"
echo "a tu configuración de Nginx (dentro del bloque 'server'):"
echo ""
echo -e "${COLOR_YELLOW}# 1. Denegar ejecución de PHP en directorios de uploads/storage${COLOR_RESET}"
echo -e "${COLOR_YELLOW}location ~* ^/(storage|public/storage|uploads|images|public/images)/.*\.php$ {${COLOR_RESET}"
echo -e "${COLOR_YELLOW}    deny all;${COLOR_RESET}"
echo -e "${COLOR_YELLOW}    return 403;${COLOR_RESET}"
echo -e "${COLOR_YELLOW}}${COLOR_RESET}"
echo ""
echo -e "${COLOR_YELLOW}# 2. Solo permitir index.php en public/ (denegar otros .php)${COLOR_RESET}"
echo -e "${COLOR_YELLOW}location ~* ^/(?!index\.php$).+\.php$ {${COLOR_RESET}"
echo -e "${COLOR_YELLOW}    deny all;${COLOR_RESET}"
echo -e "${COLOR_YELLOW}    return 403;${COLOR_RESET}"
echo -e "${COLOR_YELLOW}}${COLOR_RESET}"
echo ""
echo -e "${COLOR_YELLOW}# 3. Denegar acceso a archivos sensibles${COLOR_RESET}"
echo -e "${COLOR_YELLOW}location ~ /\.(env|git|svn|htaccess) {${COLOR_RESET}"
echo -e "${COLOR_YELLOW}    deny all;${COLOR_RESET}"
echo -e "${COLOR_YELLOW}    return 403;${COLOR_RESET}"
echo -e "${COLOR_YELLOW}}${COLOR_RESET}"
echo ""
